      ...
      <View style={styles.container}>
        ...
        <ScrollView style={{ width: 100 + "%" }}>
          <Form style={{ width: 100 + "%" }}>
            ...
            <Item floatingLabel style={{ marginRight: 16 }}>
              <Label style={styles.font}>Cena za litr (opcjonalne)</Label>
              <Input
                style={styles.font}
                keyboardType="numeric"
            ...
            <Button
              ...
              onPress={() => {
                if (this.state.litry!= null && this.state.kilometry!= null)
                this.setState({
                  wynik: (
                ...
                else Alert.alert("Błąd", "Wypełnij pola, nie mam z czego policzyć ;)");
              }}
            >
            ...
            {this.state.wynik == 0 ? (
              ...
              <View style={{ alignSelf: "center", paddingHorizontal: 32 }}>
                ...
                >Twoje średnie spalanie to:{" "}</Text>
                <Text
                  style={{
                    textAlign: "center",
            ...
            {this.state.wynik != 0 && this.state.cena != null ? (
              ...
              >
                100km kosztowało{" "}
                {(this.state.wynik * this.state.cena).toFixed(2)}
                zł
              </Text>
            ) : (
              <Text />
